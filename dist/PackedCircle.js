...
var PackedCircle = /** @class */ (function () {
    function PackedCircle(id, radius, x, y, delta) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        ...
        // Where we really are
        this._position = new Vector_1.default(x, y);
        this._previousPosition = new Vector_1.default(x, y);
        // For the div stuff  - to avoid superflous movement calls
        this._positionWithOffset = new Vector_1.default(x, y);
        this._previousPositionWithOffset = new Vector_1.default(x, y);
    ...
    Object.defineProperty(PackedCircle.prototype, "delta", {
        get: function () {
            return new Vector_1.default(this._position.x - this._previousPosition.x, this._position.y - this._previousPosition.y);
        },
        enumerable: true,
        configurable: true
    });
